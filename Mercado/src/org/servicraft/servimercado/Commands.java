                    ...
                    if (args.length < 2) {
                        ...
                        if (!EventClass.plugin3.orgcfg.contains("jugadores." + player.getName() + ".sociedad")) {
                            ...
                            if (EventClass.plugin3.orgcfg.contains("organizaciones." + args[1])) {
                                ...
                                if (value == 0) {
                                    player.sendMessage("No tienes ningúna invitación de esta sociedad!");
                                    return true;
                                } else {
                                ...
                                player.sendMessage("No existe está organización!");
                                return true;
                            }
                    ...
                    if (args.length < 2) {
                        ...
                        if (!EventClass.plugin3.orgcfg.contains("jugadores." + player.getName() + ".gremio")) {
                            ...
                            if (EventClass.plugin3.orgcfg.contains("organizaciones." + args[1])) {
                                ...
                                if (value == 0) {
                                    player.sendMessage("No tienes ningúna invitación de este gremio!");
                                    return true;
                                } else {
